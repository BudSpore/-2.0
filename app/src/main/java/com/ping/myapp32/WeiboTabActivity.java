...
import com.ping.myapp32.fragments.FourthFragment;
import com.ping.myapp32.fragments.SecondFragment;
import com.ping.myapp32.fragments.ThirdFragment;
...
public class WeiboTabActivity extends ActionBarActivity implements ViewPager.OnPageChangeListener{
    ...
    private void init(){
        ...
        String s = String.valueOf(traveller.getNumber()+2);

        mAPSTS.showDot(VIEW_SECOND,s);
    }
