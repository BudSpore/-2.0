...
public final class CaptureActivityHandler2 extends Handler {
    ...
    private final Capture2 activity;
    ...
    public CaptureActivityHandler2(Capture2 activity, Vector<BarcodeFormat> decodeFormats,
                                  String characterSet) {
        this.activity = activity;
        decodeThread = new DecodeThread2(activity, decodeFormats, characterSet,
