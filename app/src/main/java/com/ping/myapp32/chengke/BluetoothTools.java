...
public class BluetoothTools {
	...
	* Action:连接终止
	*/
	public static final String ACTION_CONNECT_STOP="ACTION_CONNECT_STOP";

	/**
	 * Action:远程距离导致的连接终止
	 */
	public static final String ACTION_CONNECT_AREA_STOP="ACTION_CONNECT_AREA_STOP";
     ...
     * Message:连接终止
 	 */
	public static final int MESSAGE_CONNECT_STOP=0x00000005;
